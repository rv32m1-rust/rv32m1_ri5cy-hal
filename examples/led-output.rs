...
#[riscv_rt::entry]
fn main() -> ! {
    let mut cp = pac::Peripherals::take().unwrap();
    ...
    let mut pta24 = porta.pta24.into_push_pull_output(&mut cp.GPIOA);
    let mut pta23 = porta.pta23.into_push_pull_output(&mut cp.GPIOA);
